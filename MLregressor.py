...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  1 10:06:36 2023
...
class MLregressor:
    def __init__ (self,Xtrain,Ytrain,rfr_trees=150,nn_layers=[120, 150, 40, 60],nn_lr=0.0008,nn_epochs=100,nn_batch_size=18,nn_validation_split=0.1):
        self.Xtrain=Xtrain
        self.Ytrain=Ytrain
